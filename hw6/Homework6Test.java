...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("the actual number of collisions is " + table.collisionNum + "\n");
    System.out.println("the expected number of collisions is " + table.expectedCollisionNum(numBoards, table.size()) + "\n");

...
class Date {
  ...
  /* Put your private data fields here. */
    ...
    private static final int LDAYS[] = {0,31,29,31,30,31,30,31,31,30,31,30,31};
  ...
  public static int daysInMonth(int month, int year) {
	  if(isLeapYear(year)) return LDAYS[month];
	  else return DAYS[month];          // replace this line with your solution
  }
  ...
  public static boolean isValidDate(int month, int day, int year) {
	  ...
	  if(isLeapYear(year)){
		  if(day < 1 || day > LDAYS[month]) return false;
		  }
  ...
  public int difference(Date d) {
	  ...
	  if(this.year >= d.year ){
		  y = this.year - d.year;
		  da = this.dayInYear() - d.dayInYear();
		  for(int i = d.year; i < this.year; i++){
		  if(isLeapYear(i)) other++;
		  }
		  return y * 365 + other + da; 
	  }
		  y = d.year - this.year;
		  da = d.dayInYear() - this.dayInYear();
  ...
  public static void main(String[] argv) {
    ...
    System.out.println("\nTesting isLeapYear.");
    System.out.println(" 2010 is a leap year should be false: " + 
                       isLeapYear(2010));
    System.out.println(" 2000 is a leap year should be true: " + 
            isLeapYear(2000));
    System.out.println(" 1900 is a leap year should be false: " + 
            isLeapYear(1900));
